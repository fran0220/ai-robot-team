...
export function AssetList({ assets, selectedAsset, onSelectAsset, loading }: AssetListProps) {
  if (loading) {
    return (
        ...
        {assets.map((asset) => {
          ...
          return (
            ...
            >
              ...
              {/* Name */}
              <h4 className="font-medium text-mc-text truncate mb-1" title={asset.name}>
                {asset.name}
              </h4>
