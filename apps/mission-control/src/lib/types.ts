...
// Document types
export type DocType = 'research' | 'spec' | 'report' | 'deliverable' | 'note';
...
// Memory types
export type MemoryType = 'fact' | 'decision' | 'preference' | 'lesson' | 'context';
...
// Asset types
export type AssetStage = 'planning' | 'design' | 'build' | 'review' | 'deliver';
export type AssetType = 'document' | 'visual' | 'model' | 'data' | 'code' | 'other';
