...
> **Team**: robotics (机器人研发团队)  
> **Workspace**: robotics

| Agent | OpenClaw ID | PostgreSQL UUID | 角色 |
|-------|-------------|-----------------|------|
| Nova | `robotics.nova` | `e01bda3b-54d7-445b-a76a-3908da4ba11d` | 项目主控 |
| Sage | `robotics.sage` | `00f2d69a-9ddd-466d-bdea-ef8b5e2ad74b` | 调研分析 |
| Atlas | `robotics.atlas` | `b16223d9-9059-454a-9516-3174ce37c5fa` | 产品经理 |
| Jarvis | `robotics.jarvis` | `b08702eb-ebc8-446b-aa7e-e010ad2a2875` | 硬件负责 |
| Friday | `robotics.friday` | `2f545ac8-0253-4ccf-b159-504d27b1c807` | 软件开发 |
| Vision | `robotics.vision` | `50770420-bbe7-4ca7-a9ea-77b3b5c46463` | 测试验证 |
| Idra | `robotics.idra` | `8531c9d1-5d33-49e1-9ba3-e50ec61bb268` | 工业设计 |
| Mech | `robotics.mech` | `9dacde45-a17e-4bec-a239-81a8d228c96f` | 机械结构 |
| Xiaomao | `robotics.xiaomao` | `08dbb2e3-c394-44b8-bf00-198a867edad9` | 辅助助手 |

> **Note**: API 调用使用 PostgreSQL UUID，配置和 @mention 使用 OpenClaw ID
